...
class SARB {
	...
	{
		$account = $this->tBot->verifyCredentials();
		echo 'Account: ', var_export($account,true),"\n";
	}
...
//$sarb->userAuthApplication ();

// $sarb->essai01('#OSM', 1000);
// $sarb->essai01('#PTCE', 1000);

$sarb->verifyCredentials();
